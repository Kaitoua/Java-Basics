  ...
  static void primitives() {
    ...
    static void insurance(){
      ...
      if (isInsured=true) {
        paidByInsurance=billAmount*coverageByInsurance;
        paidByPatient=billAmount-paidByInsurance;
      }
      System.out.println(paidByInsurance);
      System.out.println(paidByPatient);
      }
      ...
      byte narrowdByte = (byte)123456;//out of range it will assign an equalivant binary number
  ...
  static void threeDimensionalArrays() {
    ...
    System.out.println("unitsSold[0][3][1]: " + unitsSold[1][2][2]);
  } 
